...
from models import test, test_with_metrics, train_fedavg
...
class FlowerClientFedAvg(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config: Dict[str, Scalar]):
        ...
        self.net, training_metrics = train_fedavg(
            self.net,
            self.trainloader,
            validation_loader,
            self.device,
    ...
    def evaluate(self, parameters, config: Dict[str, Scalar]):
        """Server-side federated evaluation - client'ın tüm verisiyle"""
        self.set_parameters(parameters)
